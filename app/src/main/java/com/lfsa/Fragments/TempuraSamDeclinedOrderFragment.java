 ...
 */
public class TempuraSamDeclinedOrderFragment extends Fragment {
    ...
    TextView txtMealName, txtQuan, txtPrice, txtTime, txtNote, txtStatus, txtFoodStall, textView_dat;



    public TempuraSamDeclinedOrderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tempura_sam_declined_order, container, false);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TransactionHistory, TempuraSamDeclinedOrderFragment.OrderViewHolder> FBRA = new FirebaseRecyclerAdapter<TransactionHistory, TempuraSamDeclinedOrderFragment.OrderViewHolder>
                (TransactionHistory.class, R.layout.singlehistoryitem, TempuraSamDeclinedOrderFragment.OrderViewHolder.class, mDatabase.orderByChild("Foodstall_Name").equalTo("Tempura Sam")) {
            @Override
            protected void populateViewHolder(final TempuraSamDeclinedOrderFragment.OrderViewHolder viewHolder, final TransactionHistory model, int position) {
    ...
    public static class OrderViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView textView4, txtQuan, txtXPrice, textView_date;
