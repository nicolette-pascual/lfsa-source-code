 ...
 */
public class TempuraSamHistoryFragment extends Fragment {
    ...
    public TempuraSamHistoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tempurasam_history, container, false);
        ...
        mOrderList = (RecyclerView) view.findViewById(R.id.tempura_list_view);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TransactionHistory, TempuraSamHistoryFragment.OrderViewHolder> FBRA = new FirebaseRecyclerAdapter<TransactionHistory, TempuraSamHistoryFragment.OrderViewHolder>
                (TransactionHistory.class, R.layout.singlehistoryitem, TempuraSamHistoryFragment.OrderViewHolder.class, mDatabase.orderByChild("Foodstall_Name").equalTo("Tempura Sam")) {
            @Override
            protected void populateViewHolder(final TempuraSamHistoryFragment.OrderViewHolder viewHolder, final TransactionHistory model, int position) {
                ...
                mDatabase.child(order_key).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild("BulkOrder_Venue") && status_db.equals("Finished") && userId.equals(uid)){
                            ...
                            if(status_db.equals("Finished") && userId.equals(uid)){
    ...
    public static class OrderViewHolder extends RecyclerView.ViewHolder{
        ...
        public OrderViewHolder(View itemView){
            ...
            //textView_date.setText("Date Completed:");
