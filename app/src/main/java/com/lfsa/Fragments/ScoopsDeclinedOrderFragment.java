 ...
 */
public class ScoopsDeclinedOrderFragment extends Fragment {
    ...
    public ScoopsDeclinedOrderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scoops_declined_order, container, false);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TransactionHistory, ScoopsDeclinedOrderFragment.OrderViewHolder> FBRA = new FirebaseRecyclerAdapter<TransactionHistory, ScoopsDeclinedOrderFragment.OrderViewHolder>
                (TransactionHistory.class, R.layout.singlehistoryitem, ScoopsDeclinedOrderFragment.OrderViewHolder.class, mDatabase.orderByChild("Foodstall_Name").equalTo("S-coop-s")) {
            @Override
            protected void populateViewHolder(final ScoopsDeclinedOrderFragment.OrderViewHolder viewHolder, final TransactionHistory model, int position) {
