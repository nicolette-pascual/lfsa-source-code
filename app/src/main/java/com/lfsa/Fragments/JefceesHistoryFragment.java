 ...
 */
public class JefceesHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_jefcees_history, container, false);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TransactionHistory, JefceesHistoryFragment.OrderViewHolder> FBRA = new FirebaseRecyclerAdapter<TransactionHistory, JefceesHistoryFragment.OrderViewHolder>
                (TransactionHistory.class, R.layout.singlehistoryitem, JefceesHistoryFragment.OrderViewHolder.class, mDatabase.orderByChild("Foodstall_Name").equalTo("Jefcee's")) {
            @Override
            protected void populateViewHolder(final JefceesHistoryFragment.OrderViewHolder viewHolder, final TransactionHistory model, int position) {
