 ...
 */
public class ScoopsHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scoops_history, container, false);
        ...
        mOrderList = (RecyclerView) view.findViewById(R.id.scoops_list_view);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TransactionHistory, ScoopsHistoryFragment.OrderViewHolder> FBRA = new FirebaseRecyclerAdapter<TransactionHistory, ScoopsHistoryFragment.OrderViewHolder>
                (TransactionHistory.class, R.layout.singlehistoryitem, ScoopsHistoryFragment.OrderViewHolder.class, mDatabase.orderByChild("Foodstall_Name").equalTo("S-coop-s")) {
            @Override
            protected void populateViewHolder(final ScoopsHistoryFragment.OrderViewHolder viewHolder, final TransactionHistory model, int position) {
